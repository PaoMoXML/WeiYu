...
public class WxPayController implements WxPayService {
    ...
    @ApiOperation("二次签名接口")
    public Map<String,Object> createSign(@RequestParam Map<String, String> params){
    ...
    @ApiOperation("支付成功短信接口")
    public Map<String,Object> sendPaySms(String name,Double money,int course,String phone){
        ...
        try {
            smsSingleSenderResult = ssender.send(0, "86", phone,
                    SmsConfigurer.smsSign+name+"学员，今收到你的微信转账"+money+"元，共"+course+"训练课时。感谢亲对威帝体育的支持。","","");
